...
static struct bflb_eth_phy_cfg_s *phy_8720_cfg = NULL;
 ...
 *
 */
int phy_8720_auto_negotiate(struct bflb_eth_phy_cfg_s *cfg)
{
    uint16_t regval = 0;
 ...
 *
 */
int phy_8720_link_up(struct bflb_eth_phy_cfg_s *cfg)
{
    uint16_t phy_bsr = 0;
    uint16_t phy_sr = 0;
 ...
 *
 */
int phy_8720_poll_cable_status(struct bflb_eth_phy_cfg_s *cfg)
{
 ...
 *
 */
int phy_8720_init(struct bflb_device_s *emac, struct bflb_eth_phy_cfg_s *cfg)
{
    uint16_t phyReg;
